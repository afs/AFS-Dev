...
public class GraphRDFS_Orig extends GraphWrapper {
    private static Logger log = LoggerFactory.getLogger(GraphRDFS_Orig.class) ;
    ...
    public GraphRDFS_Orig(InferenceSetupRDFS setup, Graph graph) {
        super(graph) ;
        this.setup = setup ;
