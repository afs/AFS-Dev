...
// This code is parked - don't want servlet dependency 
...
// * to format pages. It isolates the use of velocity by taking a configuration
// * map. Use with a servlet mapping of "*.vm" or some such extension.
// */
...
//    /*
//     * Velocity logging Instead of internal velocity logging, we catch the
//     * exceptions, log the message ourselves. This gives a celaner log file
//     * without loosing information that the application could use.
//     */
//
...
//            if ( logger == null )
//                return ;
//            // Forget the stack trace - velcoity internal - long - unhelpful to
//            // application.
//            t = null ;
//            switch (level) {
//                case LogChute.TRACE_ID :
